  ...
  return (
    <Flex>
      ...
      <MainTemplate pathname={pathname} navbarVariant={NAVBAR_VARIANT.signUp}>
        <Flex gap={'36px'} flexDir={'column'} w={'100%'} alignItems={'center'} pt={{ base: '32px', md: '48px' }}>
          <Flex gap={'12px'} alignItems={'center'} flexDir={'column'}>
            <Text color={'primary.default'} textStyle={{ base: 'heading3', md: 'heading2'}}>
              selecione um oráculo
            </Text>
            <Text textStyle={'bodyLG'}>
              Escolha qual oráculo você deseja estudar hoje, suas anotações ficarão salvas conosco!
            </Text>
          </Flex>
          <Flex
            w={'100%'}
            ...
            gap={'20px'}
          >
            <Box position="relative" maxH="245px" w="full" rounded="8px" overflow="hidden">
              <Img
                w={'100%'}
                h={'100%'}
                objectFit={'cover'}
              ...
              <Box
                position={'absolute'}
                bgGradient={'linear(to-r, rgba(0, 0, 0, 0.50), rgba(0, 0, 0, 0.50))'}
                top={'0'}
                left={'0'}
                right={'0'}
                bottom={'0'}
